...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactBookings: Schema.Attribute.String;
    contactBookingsLink: Schema.Attribute.String;
    contactManagement: Schema.Attribute.String;
    contactManagementLink: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    credit: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Design by ANGELO'>;
...
export interface ApiCollaborationsPageCollaborationsPage
  ...
  info: {
    description: 'Feed de posts para a se\u00E7\u00E3o COLLABORATIONS';
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    heroLogo: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMusicPageMusicPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Curadoria de faixas para a se\u00E7\u00E3o MUSIC';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    selectedSoundcloudTrackIds: Schema.Attribute.JSON;
    selectedSpotifyTrackIds: Schema.Attribute.JSON;
    soundcloudTracks: Schema.Attribute.Component<
      'integrations.soundcloud-track',
      true
    >;
    spotifyTracks: Schema.Attribute.Component<
      'integrations.spotify-track',
      true
    >;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPressFeaturePressFeature
  extends Struct.CollectionTypeSchema {
  collectionName: 'press_features';
  info: {
    description: '';
    displayName: 'Press Feature';
    pluralName: 'press-features';
    singularName: 'press-feature';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::press-feature.press-feature'
    > &
      Schema.Attribute.Private;
